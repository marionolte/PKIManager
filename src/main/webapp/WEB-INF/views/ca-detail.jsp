    ...
    <div class="row g-4 mb-4">
      <div class="col-lg-7">
        <div class="info-card h-100">
          ...
          <% } %>
          <% if(revoked){ %>
          <div class="dr"><span class="dl">Revoked At:</span><%=ca.getRevokedAt()!=null?ca.getRevokedAt().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")):""%></div>
