...
<%
    ...
    long pendingCsrJobs= request.getAttribute("pendingCsrJobs")!= null ? (long)request.getAttribute("pendingCsrJobs"): 0;
...
<div class="sidebar">
  ...
  <nav class="flex-grow-1 py-2">
    ...
    <a href="<%=ctx%>/admin/csr-jobs" class="nav-link"><i class="bi bi-inbox"></i>CSR Jobs
      <% if (pendingCsrJobs > 0) { %><span class="badge bg-warning text-dark ms-1"><%=pendingCsrJobs%></span><% } %>
    </a>
...
<div class="main-content">
  <div class="topbar">
    <span style="font-weight:600;color:#0d1b2a;font-size:1.05rem;"><i class="bi bi-speedometer2 me-2"></i>Dashboard</span>
